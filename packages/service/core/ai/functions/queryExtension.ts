...
Present a step-by-step derivation of the CG coefficients using the raising and lowering operators $(J^+,J^-)$ of angular momentum. Begin with the highest weight state and then apply the lowering operator to generate other states. Use the orthogonality and normalization conditions to determine the coefficients.
----------------
