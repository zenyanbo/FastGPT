...
- So you should think about when should expand semantics (horizontally) and when should focus specified concept (vertically go deeper). If "original question" is clear, specific and non-ambiguous, go deeper. Such as the case of "spin-density waves" and "Hawking radiation", "retrieval terms" is fewer but specified because of non-ambiguity of "original question".
