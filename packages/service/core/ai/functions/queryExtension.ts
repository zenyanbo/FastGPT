...
# OUTPUT
The output is only a standard list with "Retrieval terms". Your output should STRICTLY adhere to the similar format ["terms1","terms2","terms3"]. Generally, it is enough to generate about 3 terms, with a maximum of no more than 6 terms.
## REQUIREMENTS
